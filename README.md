...
### Админ-панель
- **Заказы** (`/admin/orders`): просмотр, фильтрация, изменение статусов
- **Товары** (`/admin/products`): CRUD с загрузкой изображений
  - Создание / редактирование / удаление товаров
  - Загрузка фото (до 2 МБ, хранение в `storage/app/public/products`)
  - Фильтрация по бренду, категории, поиск по названию
...
| `/admin/products/create` | Создание товара     | Admin       |
| `/admin/products/{id}/edit` | Редактирование товара | Admin   |
| `/login`               | Вход                  | Guest       |
